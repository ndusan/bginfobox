                ...
                <? foreach ($lattestDynamicEditions as $lde): ?>
                    <li class="first">
                        ...
                        <a href="<?= $lde['link']; ?>" target="_blank">
                            <img title="<?= $_t['index.image-iyp.text'][$params['lang']] ?> <?= $lde['link']; ?>" alt="<?= $_t['index.image-iyp.text'][$params['lang']] ?> <?= $lde['link']; ?>" width="170" height="240" src="<?= (DS . 'public' . DS . 'uploads' . DS . 'pockets' . DS . 'thumb-' . $lde['image_name']); ?>" />
                        </a>
                        <? else: ?>
                        <img title="<?= $_t['index.image-iyp.text'][$params['lang']] ?> <?= $lde['link']; ?>" alt="<?= $_t['index.image-iyp.text'][$params['lang']] ?> <?= $lde['link']; ?>" width="170" height="240" src="<?= (DS . 'public' . DS . 'uploads' . DS . 'pockets' . DS . 'thumb-' . $lde['image_name']); ?>" />
                        <? endif;?>
