                ...
                <li>
                    <ul>
                        <? foreach ($galleryArchiveCollection as $gac): ?>
                            <li><a href="<?= (DS . $params['lang'] . DS . 'arhiva' . DS . 'bginfo-map'); ?>"><img title="<?= $gac['title_' . $params['lang']]; ?>" alt="<?= $gac['title_' . $params['lang']]; ?>" src="<?= (DS . 'public' . DS . 'uploads' . DS . 'bginfo' . DS . 'thumb-' . $gac['image_name']); ?>" /></a></li>
                        <? endforeach; ?>
                    </ul>
                </li>
            </ul>
