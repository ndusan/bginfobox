...
class CmsNewsModel extends Model
{
    ...
    public function updateNews($params)
    {
        ...
        try{
            $query = sprintf("UPDATE %s SET `title_sr`=:titleSr, `heading_sr`=:headingSr, `content_sr`=:contentSr, `show_en`=:showEn, 
            ...
            $stmt->bindParam(':showEn', $params['show_en'], PDO::PARAM_INT);
    ...
    public function createNews($params)
    {
        ...
        try{
            ...
            $query = sprintf("INSERT INTO %s SET `title_sr`=:titleSr, `heading_sr`=:headingSr, `content_sr`=:contentSr, `show_en`=:showEn,
